...
int main([[maybe_unused]] int argc, char *argv[])
{
    ...
    auto cameraPos = glm::vec3(0.f, 0.f, 3.0f);
    ...
    WindowBoilerplate()
        ...
        .addKeyCallback(
            'a',
            [&cameraPos, &cameraFront, &cameraUp](WindowBoilerplate &window) {
                cameraPos -= glm::normalize(glm::cross(cameraFront, cameraUp)) * window.cameraSpeed();
                return false;
            }
        )
        .addKeyCallback(
        ...
        .addKeyCallback(
            's',
            [&cameraPos, &cameraFront](WindowBoilerplate &window) {
                cameraPos -= window.cameraSpeed() * cameraFront;
                return false;
            }
        )
        .addKeyCallback(
        ...
        .run([start, &rotateCoords, &cameraPos, &cameraFront, &cameraUp,
